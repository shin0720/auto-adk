        ...
        async function loadState() {
            ...
            if (typeof restorePlanningCouncilState === 'function') restorePlanningCouncilState(data);
            if (typeof restoreFinalDecisionState === 'function') restoreFinalDecisionState(data);
